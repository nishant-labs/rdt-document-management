...
describe('components/app-management/rdt-management-app', () => {
  ...
  test('should render no data message', () => {
    ...
    expect(noMessageWrapper.prop('text')).toEqual(
      'Use search box to get Population and GDP statistics from world bank for a specific year.'
    );
  });
